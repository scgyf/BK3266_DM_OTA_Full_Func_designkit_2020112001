...
#define HCI_LINK_WAIT_RMT_AUTH  (1<<7)

#define HCI_LINK_FEATURES_REQ       (1<<8)
#define HCI_LINK_EXT_FEATURES_REQ   (1<<9)
#define HCI_LINK_FEATURES           (1<<10)
#define HCI_LINK_EXT_FEATURES       (1<<11)

#define HCI_LINK_CLOCK_REQ          (1<<12)
#define HCI_LINK_CLOCK              (1<<13)
#endif
