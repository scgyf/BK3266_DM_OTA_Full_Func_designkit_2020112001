 ...
 */
    ...
    //#define SUPPORT_BAIDU_APK                               /* supported BAIDU APK */
...
#ifdef BEKEN_OTA
#ifdef BT_DUALMODE 
#define BEKEN_OTA_BLE									/* OTA supported by BLE */
#endif
#define BEKEN_OTA_SPP									/* OTA supported by SPP */
#define BEKEN_OTA_1ST_HALF_ONLY			1				/* OTA only use 1st half*/
#endif
...
#define CONFIG_RF_CALI_TYPE         (CALI_BY_8852_BIT)//(CALI_BY_8852_BIT|CALI_BY_JZHY_BIT)
