...
static u_int32 GAP_Adv_Interval_Min = 160;//128;//160;//480;//32;   /*160=100ms;320=200ms;480=300ms,640=400ms;800=500ms*/
static u_int32 GAP_Adv_Interval_Max = 160;//;//160;//32;
...
#if  0//(PRH_BS_CFG_SYS_LE_L2CAP_INCLUDED==1)  ///change frank 210107 14:26
