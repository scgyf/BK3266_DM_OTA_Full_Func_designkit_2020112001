...
t_error GATT_Characteristic_Value_Write( u_int16 connection_handle, u_int8 write_instruct, u_int8 offset, u_int16 characteristic_value_handle, u_int16 characteristic_len, u_int8* p_characteristic, u_int8 protocol_id );//merge CEVA 0517
t_error GATT_Client_Charactaristic_Descriptor_Write(u_int16 connection_handle,  u_int16 char_desc_value_handle, u_int16 char_desc_value_len, u_int8* p_value );//merge CEVA 0517
...
u_int8 GATT_Event(u_int8 event_opcode, u_int16 handle, u_int16 payload_len, u_int8 attrib_len, u_int8* p_pdu,u_int8 status);//merge CEVA 0517
u_int8 GATT_Command_Complete_Event(u_int16 handle,u_int8 operation_id,u_int8 status);//merge CEVA 0517

void Gatt_Set_MTU_Size(u_int16 mtu_size);//merge CEVA 0517
...
void LEatt_Decode_PDU(t_LE_Connection* p_connection,u_int16 mtu_length,u_int8* p_pdu);//merge CEVA 0517
