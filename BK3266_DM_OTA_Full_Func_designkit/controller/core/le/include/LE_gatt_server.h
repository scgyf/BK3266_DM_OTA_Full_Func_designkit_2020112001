...
u_int8 GATTserver_Read_By_Group_Type(u_int16 max_result_len,u_int16 start_handle,u_int16 end_handle,u_int16 attrib_UUID,u_int8* p_result,u_int8* p_result_len,u_int8* pair_len);
...
u_int16 Gatt_Get_MTU_Size(void);
