...
#define SMP_SECURITY_REQUEST_TIME   6400
#define GAP_START_DISCOVERY_TIME    1200
#define ANCS_CONFIG_NOTIFY_START    10000
#define ANCS_CONFIG_DATA_START      11000
...
typedef struct t_App_Control
{
    ...
    u_int32 MMI_Timer[3];
	#endif
    u_int32 SMP_security_request_timer;
    u_int32 gap_discovery_request_timer;
    u_int32 ancs_config_notify_timer;
    u_int32 ancs_config_data_timer;
