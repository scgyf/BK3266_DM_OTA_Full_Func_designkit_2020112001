...
t_error LEconnection_L2CAP_Connection_Update(u_int16 handle,u_int16 interval_max,u_int16 interval_min,u_int16 latency,u_int16 timeout);
#endif
...
uint8 LEconnection_Connection_Event_Express_Pass(void);
